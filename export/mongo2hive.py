...
def json2dict_utc(json_str, init_day):
    json_dict = json.loads(json_str, object_hook=replace_query_utc(None, init_day=init_day))
    return json_dict
...
def json2dict(json_str, init_day):
    json_dict = json.loads(json_str, object_hook=replace_query(None, init_day=init_day))
    return json_dict

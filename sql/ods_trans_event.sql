create external table if not exists ods.ods_trans_event (
    ...
    inspect_at string comment "检察状态最后更新时间" ,
    comment string comment "状态变化的描述：例如旷工原因、请假原因" ,
    work_time string comment "出车日期 到仓时间" ,
    created_at string comment "任务创建时间" ,
    ...
    check_in_time string comment "签到时间" ,
    is_complete int comment "是否完成配送" ,
    complete_time string comment "司机完成配送时间" ,
    ...
    departure_time string comment "离仓打点时间" ,
